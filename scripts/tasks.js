...
// To send Frodo and Sam to Mount Doom, find Frodo's place in the 
// fellowshipMembers array in the function below using the indexOf 
// method: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/indexOf. 
// Save that value to a variable called frodosPlace. Then, use the 
// .splice method to remove and return 2 elements from the 
// fellowshipMembers array (Frodo and Sam) starting at frodosPlace: 
// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/splice. 
// The splice method has a return value, you can use that as your function return!
...
function itsDangerousToGoAlone() {
  ...
  // WRITE YOUR CODE HERE
  // console.log(fellowshipMembers.indexOf("Frodo Baggins"));
  let frodosPlace = fellowshipMembers.indexOf("Frodo Baggins");
  fellowshipMembers.splice(frodosPlace, )
}
